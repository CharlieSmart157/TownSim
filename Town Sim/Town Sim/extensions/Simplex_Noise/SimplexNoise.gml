...
/// @description simplex_raw3(x, y, z, min, max)
...
/// @description simplex_raw4(x, y, z, w, [ARRAY 1D:INT] hash, [ARRAY 1D:1D:INT] gradient, [ARRAY 1D:1D:INT] simplex, min, max)
/// @function simplex_raw4
/// @param x
/// @param  y
/// @param  z
/// @param  w
...
/// @description simplex_get_seed()
/// @function simplex_get_seed
/*
...
/// @description simplex_set_seed(seed)
/// @function simplex_set_seed
/// @param seed
/*
...
/// @description simplex_calculate_2d(x, y, min, max, octaves, persistence, scale)
/// @function simplex_calculate_2d
/// @param x
/// @param  y
/// @param  min
/// @param  max
...
/// @description simplex_calculate_2dr(x, y, min, max, octaves, persistence, scale)
/// @function simplex_calculate_2dr
/// @param x
/// @param  y
/// @param  min
/// @param  max
...
/// @description simplex_calculate_3d(x, y, z, min, max, octaves, persistence, scale)
/// @function simplex_calculate_3d
/// @param x
/// @param  y
/// @param  z
/// @param  min
...
/// @description simplex_calculate_3dr(x, y, z, min, max, octaves, persistence, scale)
/// @function simplex_calculate_3dr
/// @param x
/// @param  y
/// @param  z
/// @param  min
...
/// @description simplex_calculate_4d(x, y, z, w, min, max, octaves, persistence, scale)
/// @function simplex_calculate_4d
/// @param x
/// @param  y
/// @param  z
/// @param  w
...
/// @description simplex_calculate_4dr(x, y, z, w, min, max, octaves, persistence, scale)
/// @function simplex_calculate_4dr
/// @param x
/// @param  y
/// @param  z
/// @param  w
